...
ALTER TABLE "contacts" ADD FOREIGN KEY ("application_id") REFERENCES "applications" ("application_id")

ALTER TABLE "applications" ADD FOREIGN KEY ("contacts_id") REFERENCES "contacts" ("contact_id");
